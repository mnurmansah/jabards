  ...
  <>
    <div className="navigation-bar">
      <div className="d-flex justify-content-around align-items-center navigation-group">
        ...
        <Link className="d-flex justify-content-around align-items-center navigation-icon" to="/#n"><img src="/images/icons/person.svg" alt="person-icon" /></Link>
      </div>
      <Link to="#" className="add-button"><img src="/images/icons/pokeball-icon.svg" alt="add-icon" /></Link>
    </div>
  </>
);
